...
describe('ApiController', function () {
  beforeEach(function () {
    ...
    this.sinon.stub(_filter.default.prototype, 'populate').returns([this.recordStub]);
  });
  describe('#search', function () {
    it('returns records taken from the find method for given resource', async function () {
      const response = await this.apiController.search({
        params: {}
      }, {});
  ...
  describe('#resourceAction', function () {
    it('calls the handler of correct action', async function () {
      ...
      expect(this.action.handler).to.have.been.calledWith(this.sinon.match.any, this.sinon.match.any, this.sinon.match.has('action', this.action));
    });
  });
  describe('#recordAction', function () {
    it('calls the handler of correct action', async function () {
      ...
      expect(this.action.handler).to.have.been.calledWith(this.sinon.match.any, this.sinon.match.any, this.sinon.match.has('action', this.action).and(this.sinon.match.has('record', this.recordStub)));
    });
